...
print(lfu_cache.get(2))  # Output: 2

# Put a new key-value pair, reaching the capacity and evicting the least frequently used item (key 1)
lfu_cache.put(3, 3)

# Retrieve values again
print(lfu_cache.get(1))  # Output: -1 (key 1 was evicted)
print(lfu_cache.get(2))  # Output: 2
...
# If you un-comment line-203 & 204 you get output as below-
"""Value for key 4 4
Value for key 3 3
Value for key 2 2
Value for key 1 -1
...
Value for key 3 3
Value for key 1 -1
Value for key 2 -1 (least freq of 2 hence 2 get evicted to insert key=5)
Value for key 3 3
Value for key 4 4
Value for key 5 5"""