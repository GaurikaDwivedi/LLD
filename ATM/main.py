...
while authenticated:
    ...
    print("5. Change PIN")
    print("6. Logout")
    user_option = keypad.getInput("Enter the option number: ")

    # Perform the selected transaction based on user input
    if user_option == "1":
        amount = float(keypad.getInput("Enter the deposit amount: "))
        ...
        withdrawal_amount = float(keypad.getInput("Enter the amount to withdraw: "))
